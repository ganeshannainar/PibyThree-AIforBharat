...
Revision ID: 7cca230987b6
Revises: 
Create Date: 2025-11-26 05:55:23.510029
...
def upgrade() -> None:
    ...
    # Create user_roles enum first (before tables)
    op.execute("DO $$ BEGIN IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'user_roles') THEN CREATE TYPE user_roles AS ENUM ('admin', 'user'); END IF; END $$;")
    ...
    # Alter the column to use the enum type and set default
